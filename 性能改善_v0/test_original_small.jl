...
println("="^50)
println("Heat3D Original Version - Small Test")
println("="^50)
...
println("Executing original version...")
start_time = time()
...
try
    ...
    println("="^50)
    println("ORIGINAL VERSION RESULTS")
    println("="^50)
...
println("\nOriginal version test completed.")