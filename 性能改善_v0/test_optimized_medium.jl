...
println("="^50)
println("Heat3D Optimized Version - Medium Test")
println("="^50)
...
println("Executing optimized version (medium scale)...")
start_time = time()
...
try
    ...
    println("="^50)
    println("OPTIMIZED VERSION RESULTS (MEDIUM)")
    println("="^50)
    ...
    # 結果保存
    global optimized_result_medium = Dict(
...
println("\nOptimized version medium test completed.")